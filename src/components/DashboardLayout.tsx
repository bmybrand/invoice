...
function LeadsIcon({ className = 'h-5 w-5 text-slate-400' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.75 6.75A2.25 2.25 0 016 4.5h12A2.25 2.25 0 0120.25 6.75v10.5A2.25 2.25 0 0118 19.5H6a2.25 2.25 0 01-2.25-2.25V6.75z"
      />
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 9h9m-9 3.75h9M7.5 16.5h4.5" />
    </svg>
  )
}
...
const allNavItems: Array<{ label: string; href: string }> = [
  ...
  { label: 'Website Audits', href: '/dashboard/audits' },
